...
function analyzeLevel(question: string) {
  ...
  const level2 = ['왜','이유','까닭','원인','무엇 때문에','뜻','의미','특징','역할','구조','원리','개념','방법','과정','차이점','이란 무엇','란 무엇','은 무엇인가','는 무엇인가','성질','어떻게 해서','어떻게 생겨','어떻게 만들어','어떻게 되는','어떻게 일어','어떻게 작동','어떻게 움직','어떻게 되나요','어떻게 이루어','왜 그럴까','왜 그런가','왜 생기','왜 발생','왜 일어','무슨 이유','어떤 이유','어떤 원인','공통점','비교','차이가','비슷한 점','다른 점','어떤 차이','어떻게 다를까','다를까','같을까'];
...
2단계(개념 이해): 뜻·특징·역할·원리를 묻거나, 두 대상의 공통점·차이점을 개념적으로 비교하는 질문 (조건 변화 없음)
