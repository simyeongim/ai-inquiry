...
- improvePoint: 1번에서 보완할 부분이 있으면 구체적으로 제안 (1~2문장). 단, 핵심 개념을 정확하게 설명한 경우에는 억지로 보완점을 만들지 말고 반드시 "핵심 개념을 정확하게 정리하여 추가로 보완할 내용은 없어요."라고 작성
- secondTitle: 2번(새롭게 알게 된 내용 또는 궁금한 점)을 분석하여, 새로운 사실/개념을 서술했으면 "🔍 새롭게 이해한 내용", 질문이나 궁금증을 썼으면 "🔍 좋은 질문" 중 하나만 선택
