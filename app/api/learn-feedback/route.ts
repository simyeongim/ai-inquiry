...
절대 금지: 학생 문장 그대로 복사, 새로운 개념 강의, 교과서 밖 내용 제시, 억지 보완점 생성, "학생이"로 문장 시작.
문장 시작: "학생이"로 시작하지 마세요. 개념이나 내용을 주어로 하거나 서술형으로 시작하세요.`;
...
- improvePoint: status 🟢 → "핵심 개념을 잘 정리했어요." / 🟡·🔴 → 부족한 부분과 수정 방향 1~2문장. 어미는 "~노력해보세요.", "~생각해보세요.", "~써보세요." 형태로 끝낼 것. "~도와주세요.", "~바랍니다." 같은 어미 금지.
